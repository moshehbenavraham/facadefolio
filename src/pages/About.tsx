...
const About = () => {
  const aboutJsonLd = {
    ...
    name: "About Architecture Blog",
    description:
      "Editorial began with a simple question — what if thoughtful ideas, meaningful stories, and beautiful design came together to enrich our daily lives?",
  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        title="About"
        description="The story behind our Nordic architecture editorial — our values, our mission, and the design-forward principles that shape every piece we publish."
        jsonLd={aboutJsonLd}
      />
      <Header />
      ...
      <Section>
        <div className="max-w-[110rem] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <AppearOnScroll delay={0}>
              <div className="lg:col-span-1 p-8 rounded-2xl bg-[rgba(197,159,255,0.15)] dark:bg-[rgba(197,159,255,0.18)]">
                <Sparkles className="w-[48px] h-[48px] text-foreground mb-4" aria-hidden="true" />
                <h3 className="text-[2.2rem] font-semibold mb-3 text-foreground">Authenticity</h3>
                <p className="text-[1.6rem] leading-[1.8] text-foreground/85">
            ...
            <AppearOnScroll delay={150}>
              <div className="lg:col-span-2 p-8 rounded-2xl bg-[rgba(255,149,238,0.15)] dark:bg-[rgba(255,149,238,0.18)]">
                <Palette className="w-[48px] h-[48px] text-foreground mb-4" aria-hidden="true" />
                <h3 className="text-[2.2rem] font-semibold mb-3 text-foreground">Thoughtfulness</h3>
                <p className="text-[1.6rem] leading-[1.8] text-foreground/85">
            ...
            <AppearOnScroll delay={300}>
              <div className="lg:col-span-2 p-8 rounded-2xl bg-[rgba(255,207,109,0.15)] dark:bg-[rgba(255,207,109,0.18)]">
                <Heart className="w-[48px] h-[48px] text-foreground mb-4" aria-hidden="true" />
                <h3 className="text-[2.2rem] font-semibold mb-3 text-foreground">Inclusivity</h3>
                <p className="text-[1.6rem] leading-[1.8] text-foreground/85">
            ...
            <AppearOnScroll delay={450}>
              <div className="lg:col-span-1 p-8 rounded-2xl bg-[rgba(254,185,131,0.15)] dark:bg-[rgba(254,185,131,0.18)]">
                <Users className="w-[48px] h-[48px] text-foreground mb-4" aria-hidden="true" />
                <h3 className="text-[2.2rem] font-semibold mb-3 text-foreground">Sustainability</h3>
                <p className="text-[1.6rem] leading-[1.8] text-foreground/85">
