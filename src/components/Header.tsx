...
const Header = () => {
  ...
  return (
    <>
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:fixed focus:top-3 focus:left-3 focus:z-[100] focus:px-4 focus:py-2 focus:rounded-md focus:bg-foreground focus:text-background focus:text-[1.4rem] focus:font-medium focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-foreground"
      >
        Skip to content
      </a>
    <header
